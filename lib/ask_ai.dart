...
class _AskAIPageState extends State<AskAIPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFF32343E), // Background color of the page
      appBar: AppBar(
        title: Text(
          'Ask AI',
      ...
      body: Column(
        children: [
                ...
                return Align(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: message['role'] == 'user' ? Color(0xFF98FB98) : Color(0xFF787D96), // Color based on role
          ...
          Container(
            color: Color(0xFF494E64), // Color of the container surrounding the text field
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  icon: Icon(Icons.send, color: Color(0xFF98FB98)), // Color of the send icon
                  onPressed: () {
                    _sendMessage();
                  },
                ),
      ...
      bottomNavigationBar: BottomMenu(activePage: 'ask_ai'),
    );
  }
